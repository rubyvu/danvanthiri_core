module DanvanthiriCore
  class Appointment < ActiveRecord::Base
    ...
    scope :history, -> {where("danvanthiri_core_appointments.status = 2 or (danvanthiri_core_appointments.booktime < ? or danvanthiri_core_appointments.status=1)", DateTime.now)}
